...
namespace FBMS.SharedKernel.Interfaces
{
    public interface IRepository
    {
        ...
        Task<TEntity> GetBySpecificationAsync<TEntity>(ISpecification<TEntity> specification) where TEntity : BaseEntity, IAggregateRoot;
        Task<List<TEntity>> ListAsync<TEntity>() where TEntity : BaseEntity, IAggregateRoot;
        Task<List<TEntity>> ListAsync<TEntity>(ISpecification<TEntity> specification) where TEntity : BaseEntity, IAggregateRoot;
